...
public class SignUpWindow extends JFrame implements ActionListener
{
	...
	JLabel imgLabel = new JLabel(new ImageIcon("bankReceptionist.jpg"));
	...
	void createNewAccount() throws ClassNotFoundException, SQLException
	{
		String sex;
		Date d;
		Account ac;
		...
		String date=Integer.toString((int)year.getSelectedItem())+Integer.toString((int)month.getSelectedItem())+Integer.toString((int)day.getSelectedItem());
		...
		JOptionPane.showMessageDialog(null,"Account No:"+Account.accountNo+"PIN:"+ Account.password,"Success", JOptionPane.INFORMATION_MESSAGE );
